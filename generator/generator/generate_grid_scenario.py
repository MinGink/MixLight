...
def parse_args():
    ...
    parser.add_argument("--rowNum", type=int, default=3)
    parser.add_argument("--colNum", type=int, default=4)
    parser.add_argument("--rowDistance", type=int, default=600)
    parser.add_argument("--columnDistance", type=int, default=600)
    ...
    parser.add_argument("--turn", action="store_true",default= True)
    parser.add_argument("--tlPlan", action="store_true",default= True)
